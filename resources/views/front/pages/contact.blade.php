            ...
            <div>
                ...
                <div class="mt-10 space-y-6 text-sm text-black/75">
                    ...
                    @if (!empty($settings['whatsapp']))
                        <p><span class="block text-[9px] uppercase tracking-[.24em] text-[#817a72] mb-2">WhatsApp</span>
                            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings['whatsapp']) }}"
                                target="_blank" rel="noopener noreferrer"
                                class="inline-flex items-center gap-3 hover:underline text-[#171717]">
                                <svg class="h-5 w-5 text-[#25D366] shrink-0" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    @if (!empty($settings['instagram']) || !empty($settings['facebook']) || !empty($settings['youtube']))
                        <div>
                            <span class="block text-[9px] uppercase tracking-[.24em] text-[#817a72] mb-3">Connect & Socials</span>
