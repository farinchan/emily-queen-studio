...
<section class="auth__panel">
    ...
    <div class="auth__form">
        <div>
            ...
            <p class="text-muted-foreground mt-1">Masuk ke dashboard admin Emily Queen Studio.</p>
        </div>
        ...
        <form action="{{ route('login') }}" method="POST" class="flex flex-col gap-4">
            ...
            <div class="field">
                ...
                <div class="input-group input-group--lg">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" class="input" id="loginEmail" placeholder="you@gariskode.com"
            ...
            <div class="field">
                ...
                <div class="input-group input-group--lg">
                    ...
                    <input type="password" name="password" class="input" id="loginPassword" placeholder="••••••••••"
            ...
            <div class="field__item">
                <input class="checkbox" type="checkbox" name="remember" value="1" id="loginRemember" />
                <label class="field__label" for="loginRemember">Ingat saya</label>
            </div>
